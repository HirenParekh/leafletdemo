...
@Component({
  selector: 'app-live-well-info',
  templateUrl: './live-well-info.component.html',
  styleUrls: ['../../../assets/scss/static-info-filter.css', './live-well-info.component.css']
})
export class LiveWellInfoComponent implements OnInit {

  filterType: string;

  filter = StaticInfoFilterConstants.LIVE_WELL;
  filterValue: any;
